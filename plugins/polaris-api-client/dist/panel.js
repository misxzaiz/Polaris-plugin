...
`||i==="\r"?a&&(t.push(n),n="",a=!1):(n+=i,a=!0)}return a&&t.push(n),t}function lt(e,t){let n=t.indexOf(":");if(n<0){e.push({id:K(),enabled:!0,key:t.trim(),value:""});return}e.push({id:K(),enabled:!0,key:t.slice(0,n).trim(),value:t.slice(n+1).trim()})}function K(){return"id"+Date.now().toString(36)+Math.random().toString(36).slice(2,7)}function Te(e,t){let n=l=>t?resolveVars(l,t):l,o=l=>"'"+String(l).replace(/'/g,"'\\''")+"'",a=n(e.url||"");/^[a-zA-Z][a-zA-Z0-9+.\-]*:\/\//.test(a)||(a="https://"+a);let r=["curl -X "+e.method+" "+o(a)],i={};e.headers&&e.headers.filter(l=>(l.enabled!==!1||l.on!==!1)&&(l.key||l.k)).forEach(l=>i[n(l.key||l.k)]=n(l.value||l.v||""));let s=null;return["GET","HEAD"].includes(e.method)||(e.bodyType==="json"?(s=n(e.body||""),Object.keys(i).some(l=>l.toLowerCase()==="content-type")||(i["Content-Type"]="application/json")):e.bodyType==="text"?s=n(e.body||""):e.bodyType==="form"&&Array.isArray(e.formBody)&&(s=e.formBody.filter(l=>(l.enabled!==!1||l.on!==!1)&&(l.key||l.k)).map(l=>encodeURIComponent(n(l.key||l.k))+"="+encodeURIComponent(n(l.value||l.v||""))).join("&"))),Object.entries(i).forEach(([l,p])=>r.push("-H "+o(l+": "+p))),s&&r.push("--data-raw "+o(s)),r.join(` \\
  `)}function pt(e,t,n){let o=p=>n?resolveVars(p,n):p,a=o(e.url||"");/^[a-zA-Z][a-zA-Z0-9+.\-]*:\/\//.test(a)||(a="https://"+a);let r={};e.headers&&e.headers.filter(p=>(p.enabled!==!1||p.on!==!1)&&(p.key||p.k)).forEach(p=>r[o(p.key||p.k)]=o(p.value||p.v||""));let i=(e.method||"GET").toUpperCase(),s=null;["GET","HEAD"].includes(i)||(e.bodyType==="json"||e.bodyType==="text")&&(s=o(e.body||""));let l={curl:Te(e,n),python:`import requests
